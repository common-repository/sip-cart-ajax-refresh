...
$extensions = array(
    '1' => (object) array(
        ...
        'url'       => SIP_WPGUMBY_THEME_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_CAWC_VERSION .'&utm_campaign=' .SIP_CAWC_UTM_CAMPAIGN,
        'title'     => SIP_WPGUMBY_THEME,
        'desc'      => __( 'Flat and responsive WooCommerce theme.<br>', 'sip-cart-ajax-refresh' ),
    ),
	);
?>
    ...
    $description = $extension->desc ; 
      ...
      <p><?php echo $description ?></p>
			...
			<div class="sip-addon-action">
				<a class="active-addon sip button button-primary " title="<?php echo $title; ?>" href="<?php echo $url; ?>" target="_blank"><?php _e('Learn more','sip-cart-ajax-refresh');?></a>
			</div>
		</div> <!-- .sip-addon -->
	<?php $i++; 
	} 
